...
A migração inicial está em [supabase/migrations/20260919000000_learning_platform.sql](supabase/migrations/20260919000000_learning_platform.sql). As migrações seguintes são incrementais; as mais recentes adicionam score oficial server-side, operações explícitas de tentativa, códigos com aproximadamente 60 bits, `teacher_profiles`, soft delete de documentos e revisão determinística. Todas as tabelas expostas têm RLS habilitado e grants explícitos.
